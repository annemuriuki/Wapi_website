    ...
    <nav className="custom-navbar" aria-label="Main Navigation">
      ...
      <div className="navbar-center">
        <ul className="navbar-links" role="menubar">
          <li role="none"><Link to="/" className="navbar-link" role="menuitem">Home</Link></li>
          <li role="none"><Link to="/about" className="navbar-link" role="menuitem">About</Link></li>
          <li role="none"><Link to="/solutions" className="navbar-link" role="menuitem">Solutions</Link></li>
          <li role="none"><Link to="/blog" className="navbar-link" role="menuitem">Blog</Link></li>
          <li role="none"><Link to="/pricing" className="navbar-link" role="menuitem">Pricing</Link></li>
          <li role="none"><Link to="/faq" className="navbar-link" role="menuitem">FAQs</Link></li>
          <li role="none"><Link to="/contact" className="navbar-link" role="menuitem">Contact</Link></li>
        </ul>
      </div>
