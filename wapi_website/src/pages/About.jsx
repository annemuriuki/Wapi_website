...
import { SiGmail } from 'react-icons/si';   // For Gmail (from Simple Icons)
// You might choose other icon sets too, like:
// import { MdEmail } from 'react-icons/md'; // For a generic email icon from Material Design
      ...
      <section className="hero-section">
        <div className="hero-container">
          {/* <div className="breadcrumbs">
            <a href="/"></a> <span className="separator"></span> <span>About Us</span>
          </div> */}
        ...
        <div className="container">
          ...
          <div className="mission-block block">
            ...
            <ul className="block-list">
              ...
              {/* Add more mission points if available */}
            </ul>
          </div>
        </div>
      </section>
              ...
              <div className="member-info">
                ...
                <div className="social-links">
                  <a href="#" className="linkedin-icon">
                    <FaLinkedinIn size={24} color="#0A4834" /> {/* Customize size and color */}
                  </a>
                  <a href="#" className="gmail-icon">
                    <SiGmail size={24} color="#0A4834" /> {/* Customize size and color */}
                  </a>
                </div>
              </div>
            </div>
