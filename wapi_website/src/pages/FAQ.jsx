...
import './FAQ.css';
// import { ReactComponent as QuestionMarkIcon } from './question-mark.svg'; // Optional icon
...
const FAQ = () => {
  ...
  // Generic FAQ content for template display
  const templateFaqs = [
    {
  ...
  return (
    <div className="faq-container"> {/* This remains the main white box container */}
      <div className="faq-header">
        {/* <QuestionMarkIcon className="faq-icon" /> */}
        <p>Find answers to your most common questions below.</p>
      </div>
      <h2>Frequently Asked Questions</h2> {/* Main title */}
